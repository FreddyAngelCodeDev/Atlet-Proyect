import 'package:atlet/Frames/ClientFrames/d_c_m_s_client.dart';

import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class WidgetMenuServices extends StatefulWidget {
  const WidgetMenuServices({super.key});

  @override
  State<WidgetMenuServices> createState() => _WidgetMenuServices();
}

class _WidgetMenuServices extends State<WidgetMenuServices> {
  @override
                        ...
                        onPressed: () {
                          setState(() {
                            Navigator.of(context).push(CupertinoPageRoute(
                              ...
                              return const MyDirectionClientMsFrame();
                            }));
                          });
                        },
                        child: Text("Aceptar")),
