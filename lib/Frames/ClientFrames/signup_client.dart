...
class MySignUpClientFrame extends StatefulWidget {
  const MySignUpClientFrame({super.key});

  @override
  State<MySignUpClientFrame> createState() => _MySignUpClientFrame();
}

class _MySignUpClientFrame extends State<MySignUpClientFrame> {
  bool? _check = false;
  @override
