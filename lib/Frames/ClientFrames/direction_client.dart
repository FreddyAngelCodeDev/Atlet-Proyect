import 'package:atlet/Frames/ClientFrames/m_s_c_d_client.dart';
...
class MyDirectionClientFrame extends StatefulWidget {
  const MyDirectionClientFrame({super.key});

  @override
  State<MyDirectionClientFrame> createState() => _MyDirectionClientFrame();
}

class _MyDirectionClientFrame extends State<MyDirectionClientFrame> {
  @override
                  ...
                  onPressed: () {
                    setState(() {
                      Navigator.of(context).push(
                        ...
                        return const MyMenuServiceClientDcFrame();
                      }));
                    });
                  },
                  child: Row(
